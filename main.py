...
end_time = "21:15" #@param {type:"string"}
...
def mode_1(roombooker, num_room, bot, st_form, et_form):
    while True:
        try:
            # refresh
            localtime = datetime.datetime.now(timezone) 
            ...
            break
        except (http.client.RemoteDisconnected, WebDriverException) as e:
                # time.sleep(1)
...
if __name__ == '__main__':
    ...
    if mode==1:
        ...
        mode_1(roombooker, num_room, telebot, st_form, et_form)
